              ...
              <div className="space-y-3">
                {completedSubmissions.length === 0 ? (
                  ...
                  completedSubmissions.map((sub, i) => (
                    <motion.div
                      key={sub.id}
                      className="p-4 rounded-xl card-nuclear border border-green-500/10 hover:border-green-500/20 transition-colors"
                      ...
                      <div className="flex gap-4">
                        {sub.result_image_url && (
                          <img
                            ...
                            alt={sub.title}
                            className="w-32 h-20 object-cover rounded-lg border border-border shrink-0"
                          />
                        )}
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between gap-2">
                            <div>
                              <h3 className="font-semibold text-foreground text-sm">{sub.title}</h3>
                          ...
                          {sub.result_image_url && (
                            ...
                            >
                              <Download size={14} className="mr-1" /> Download 4K
                            </Button>
                          )}
                        </div>
                      </div>
